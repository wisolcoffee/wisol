...
export default function Home() {
  return (
    <div>
      ...
      <br />
      <br />
      <div className="rounded bg-[#001823] pt-6">
        {" "}
        <h2 class="text-center text-4xl font-bold text-[#ffffff] text-white">
          Currently on sale
        </h2>
        <div class="grid grid-cols-1 gap-4 pb-10 pl-5 pr-5 pt-10 sm:grid-cols-2 md:grid-cols-4">
          <Card
            className="max-w-sm"
          ...
          >
            ...
            <div className="flex items-center justify-between">
              <span className="text-3sm font-bold text-gray-900 dark:text-white">
                <s>35.000đ</s> -&gt; 20.000đ
              </span>
              <br />
              <a
      ...
      <div className="overflow-y-auto">
        <Table striped className="text-xl">
          <Table.Head className="text-xl ">
            ...
            <Table.HeadCell>
              <div className="flex items-center">
                <HiMiniReceiptPercent className="mr-2" />
      ...
      <div className="pb-6 pt-6">
        ...
        <div className="h-56 sm:h-64 xl:h-80 2xl:h-96">
          <Carousel className="border-gray rounded border">
